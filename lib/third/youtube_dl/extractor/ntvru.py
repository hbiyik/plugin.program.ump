    ...
    _TESTS = [
        {
            ...
            'info_dict': {
                'id': '746000',
                'ext': 'mp4',
                'title': 'Командующий Черномор�?ким флотом провел переговоры в штабе ВМС Украины',
                'description': 'Командующий Черномор�?ким флотом провел переговоры в штабе ВМС Украины',
        ...
        },
        {
            ...
            'info_dict': {
                'id': '750370',
                'ext': 'mp4',
                'title': 'Родные па�?�?ажиров пропавшего Boeing не вер�?т в трагиче�?кий и�?ход',
                'description': 'Родные па�?�?ажиров пропавшего Boeing не вер�?т в трагиче�?кий и�?ход',
                'thumbnail': 're:^http://.*\.jpg',
                'duration': 172,
            },
        },
        {
            ...
            'info_dict': {
                'id': '747480',
                'ext': 'mp4',
                'title': '«Сегодн�?». 21 марта 2014 года. 16:00',
                'description': '«Сегодн�?». 21 марта 2014 года. 16:00',
                'thumbnail': 're:^http://.*\.jpg',
                'duration': 1496,
            },
        },
        {
            ...
            'info_dict': {
                'id': '1007609',
                'ext': 'mp4',
                'title': 'О�?тро�?южетный фильм «Кома»',
                'description': 'О�?тро�?южетный фильм «Кома»',
                'thumbnail': 're:^http://.*\.jpg',
                'duration': 5592,
            },
        },
