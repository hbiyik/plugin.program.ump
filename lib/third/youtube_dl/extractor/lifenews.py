...
class LifeNewsIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            'id': '152125',
            'ext': 'mp4',
            'title': 'В Сети по�?вило�?ь видео захвата «Правым �?ектором» колхозных полей ',
            'description': 'Жители двух по�?елков Днепропетров�?кой обла�?ти не про�?тили радикалам угрозу лишени�? плодородных земель и пошли в лобовую. ',
        ...
        'info_dict': {
            'id': '153461',
            'title': 'В Мо�?кве �?па�?ли потер�?вшего�?�? медвежонка, который �?пр�?тал�?�? на дереве',
            'description': 'Маленький хищник не �?мог найти дорогу домой и обрел временное убежище на тополе недалеко от жилого ма�?�?ива, пока его не нашла �?о�?ед�?ка�? �?обака.',
        ...
        'playlist': [{
            ...
            'info_dict': {
                'id': '153461-video1',
                'ext': 'mp4',
                'title': 'В Мо�?кве �?па�?ли потер�?вшего�?�? медвежонка, который �?пр�?тал�?�? на дереве (Видео 1)',
                'description': 'Маленький хищник не �?мог найти дорогу домой и обрел временное убежище на тополе недалеко от жилого ма�?�?ива, пока его не нашла �?о�?ед�?ка�? �?обака.',
                'upload_date': '20150505',
            },
        }, {
            ...
            'info_dict': {
                'id': '153461-video2',
                'ext': 'mp4',
                'title': 'В Мо�?кве �?па�?ли потер�?вшего�?�? медвежонка, который �?пр�?тал�?�? на дереве (Видео 2)',
                'description': 'Маленький хищник не �?мог найти дорогу домой и обрел временное убежище на тополе недалеко от жилого ма�?�?ива, пока его не нашла �?о�?ед�?ка�? �?обака.',
                'upload_date': '20150505',
            },
        }],
    ...
    def _real_extract(self, url):
        ...
        title = remove_end(
            ...
            ' - Первый по �?рочным ново�?т�?м — LIFE | NEWS')
